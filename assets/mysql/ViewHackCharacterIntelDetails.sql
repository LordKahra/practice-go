...
SELECT intel.id as id, char_intel.character_id AS character_id, intel.name AS name, intel.type_id as type_id, hzit.name as type_name, intel.target as target, char_intel.is_visible as is_visible
